...
from .models import Canal, CanalMensaje, CanalUsuario, User
...
from App_Mensajeria.models import displayusername
...
class Inbox(View):
    def get(self, request):
        ...
        return render(request, 'App_Mensajeria/inbox.html', context)
...
class CanalDetailView(LoginRequiredMixin, CanalFormMixin, DetailView):
    template_name = "App_Mensajeria/canal_detail.html"
